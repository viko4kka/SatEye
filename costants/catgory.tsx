export const categories = [
  ...
  { name: "Disaster Monitoring", group: "disaster" },
  { name: "TDRSS", group: "tdrss" },
  { name: "ARGOS DCS", group: "argos" },
  ...
  { name: "SES", group: "ses" },
  { name: "Eutelsat", group: "eutelsat" },
  { name: "Telesat", group: "telesat" },
  { name: "Starlink", group: "starlink" },
  { name: "OneWeb", group: "oneweb" },
  { name: "Qianfan", group: "qianfan" },
  { name: "Hulianwang", group: "hulianwang" },
  { name: "Kuiper", group: "kuiper" },
  ...
  { name: "Experimental Comm", group: "expcomm" },
  { name: "Other Communications", group: "other-comm" },

  // Navigation Satellites
  { name: "GNSS", group: "gnss" },
  { name: "GPS Operational", group: "gps" },
  { name: "GLONASS Operational", group: "glo" },
  { name: "Galileo", group: "galileo" },
  { name: "Beidou", group: "beidou" },
  { name: "WAAS/EGNOS/MSAS", group: "sbas" },
  { name: "Navy NavSat System (NNSS)", group: "nnss" },
  { name: "Russian LEO Navigation", group: "leo-nav" },
